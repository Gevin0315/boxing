...
-- 初始化财务订单数据
INSERT INTO `finance_order` (`order_no`, `member_id`, `member_card_id`, `card_id`, `amount`, `type`, `order_category`, `pay_method`, `remark`, `paid_amount`, `payment_status`, `create_by`) VALUES
-- 活期充值订单 (order_category=1, 已支付)
('FO202401010001', 1, NULL, NULL, 5000.00, 1, 1, 1, '会员充值', 5000.00, 1, 1),
('FO202401020001', 2, NULL, NULL, 3000.00, 1, 1, 2, '会员充值', 3000.00, 1, 1),
('FO202401030001', 3, NULL, NULL, 10000.00, 1, 1, 3, '会员充值-钻石卡', 10000.00, 1, 1),
('FO202401050001', 4, NULL, NULL, 2000.00, 1, 1, 4, '会员充值', 2000.00, 1, 2),
('FO202401060001', 5, NULL, NULL, 8000.00, 1, 1, 1, '会员充值-金卡', 8000.00, 1, 1),
-- 购卡订单 (order_category=2, 已支付)
('FO202401150001', 1, 1, 1, 299.00, 2, 1, 1, '购买团课月卡', 299.00, 1, 1),
('FO202401150002', 1, 8, 3, 3299.00, 2, 3, 3, '购买10次私教卡', 3299.00, 1, 1),
('FO202401200001', 2, 2, 2, 699.00, 2, 2, 2, '购买团课季卡', 699.00, 1, 1),
('FO202401200002', 2, 5, 5, 699.00, 2, 5, 5, '购买10次团课卡', 699.00, 1, 2),
('FO202401250001', 3, 3, 1, 1999.00, 2, 1, 3, '购买团课年卡', 1999.00, 1, 1),
('FO202401250002', 3, 7, 7, 1199.00, 2, 7, 7, '购买20次团课卡', 1199.00, 1, 1),
-- 购卡订单 (order_category=2, 待支付 - 微信/支付宝)
('FO202403010001', 4, NULL, 3, 699.00, 2, 1, 1, '购买团课季卡', 0.00, 0, 2),
('FO202403020001', 5, NULL, 8, 1199.00, 2, 2, 2, '购买20次团课卡', 0.00, 0, 1),
-- 课程消费订单 (order_category=3, 已支付)
('FO202402010001', 1, 1, NULL, -99.00, 3, 3, 5, '课程消费-拳击基础', 99.00, 1, 1),
('FO202402020001', 3, 3, NULL, -129.00, 3, 3, 5, '课程消费-巴西柔术', 129.00, 1, 1);
...
-- 初始化卡片使用记录数据
INSERT INTO `card_usage_record` (`member_card_id`, `member_id`, `usage_type`, `schedule_id`, `training_record_id`, `sessions_before`, `sessions_after`, `remark`, `create_by`) VALUES
-- 张三的卡使用记录 (member_card_id=1, 年卡)
(1, 1, 1, NULL, NULL, NULL, NULL, '团课年卡激活', 2),
(1, 1, 2, 1, 1, NULL, NULL, '拳击基础课签到', 2),
(1, 1, 2, 3, 3, NULL, NULL, '巴西柔术课签到', 2),
-- 张三的私教卡使用记录 (member_card_id=2)
(2, 1, 1, NULL, NULL, 10, 10, '10次私教卡激活', 2),
(2, 1, 2, 8, NULL, 10, 9, '拳击私教签到', 2),
(2, 1, 2, 8, NULL, 9, 8, '拳击私教签到', 3),
(2, 1, 2, 8, NULL, 8, 7, '拳击私教签到', 3),
-- 李四的卡使用记录
(3, 2, 1, NULL, NULL, NULL, NULL, '团课季卡激活', 2),
(3, 2, 2, 1, 2, NULL, NULL, '拳击基础课签到', 2),
(3, 2, 2, 2, NULL, NULL, NULL, '泰拳入门课签到', 2),
(4, 2, 1, NULL, NULL, 10, 10, '10次团课卡激活', 2),
(4, 2, 2, 4, NULL, 10, 9, '健身搏击课签到', 2),
(4, 2, 2, 5, NULL, 9, 8, '拳击基础课签到', 2),
(4, 2, 2, 6, NULL, 8, 7, '泰拳课签到', 2),
(4, 2, 2, 7, NULL, 7, 6, '巴西柔术课签到', 2),
-- 王五的卡使用记录
(5, 3, 1, NULL, NULL, NULL, NULL, '团课年卡激活', 2),
(5, 3, 2, 1, NULL, NULL, NULL, '新年第一练-拳击基础', 2),
(5, 3, 2, 2, NULL, NULL, NULL, '泰拳课签到', 2),
(6, 3, 1, NULL, NULL, 20, 20, '20次私教卡激活', 2),
(6, 3, 2, 8, NULL, 20, 19, '泰拳私教签到', 4),
(6, 3, 2, 8, NULL, 19, 18, '泰拳私教签到', 4),
(6, 3, 2, 8, NULL, 18, 17, '泰拳私教签到', 4),
(6, 3, 2, 8, NULL, 17, 16, '泰拳私教签到', 4),
(6, 3, 2, 8, NULL, 16, 15, '泰拳私教签到', 4),
-- 赵六的卡使用记录
(7, 4, 1, NULL, NULL, 1, 1, '单次日卡激活并使用', 2),
(7, 4, 2, 5, NULL, 1, 0, '单次日卡签到', 2),
(7, 4, 3, NULL, NULL, 0, 0, '卡片过期', NULL),
-- 钱七的卡使用记录
(8, 5, 1, NULL, NULL, NULL, NULL, '团课季卡激活', 2),
(8, 5, 2, 1, NULL, NULL, NULL, '拳击基础课签到', 2),
(8, 5, 2, 2, NULL, NULL, NULL, '泰拳课签到', 2),
(9, 5, 1, NULL, NULL, 20, 20, '20次团课卡激活', 2),
(9, 5, 2, 3, NULL, 20, 19, '巴西柔术课签到', 2),
(9, 5, 2, 4, NULL, 19, 18, '健身搏击课签到', 2),
(9, 5, 2, 1, NULL, 18, 17, '拳击基础课签到', 2),
(9, 5, 2, 2, NULL, 17, 16, '泰拳课签到', 2),
(9, 5, 2, 6, NULL, 16, 15, '健身搏击课签到', 2),
(9, 5, 2, 7, NULL, 15, 14, '巴西柔术课签到', 2),
(9, 5, 2, 5, NULL, 14, 13, '拳击基础课签到', 2),
(9, 5, 2, 1, NULL, 13, 12, '拳击基础课签到', 2),
-- 已作废卡片的记录
(11, 2, 1, NULL, NULL, 10, 10, '10次团课卡激活', 2),
(11, 2, 2, NULL, NULL, 10, 9, '团课签到', 2),
(11, 2, 2, NULL, NULL, 9, 8, '团课签到', 2),
(11, 2, 2, NULL, NULL, 8, 7, '团课签到', 2),
(11, 2, 2, NULL, NULL, 7, 6, '团课签到', 2),
(11, 2, 2, NULL, NULL, 6, 5, '团课签到', 2),
(11, 2, 2, NULL, NULL, 5, 4, '团课签到', 2),
(11, 2, 2, NULL, NULL, 4, 3, '团课签到', 2),
(11, 2, 4, NULL, NULL, 3, 3, '会员申请退款-卡片作废', 1);
